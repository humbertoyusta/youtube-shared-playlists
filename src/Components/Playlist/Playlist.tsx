...
import {PlaylistButtonListStyled, PlaylistStyled, PlaylistTitleStyled, PlaylistWrapperStyled} from "./Playlist.styled";
...
export default function Playlist({name, videos, removeVideoFromPlaylist, shuffleVideos, playVideo}: PlaylistProps) {
